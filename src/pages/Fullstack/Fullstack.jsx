...
const Fullstack = () => {
  ...
  return (
    <>
      <ScrollToTop />
      <Navbar />
      <div className="flex lg:flex-row 2xl:flex-row 3xl:flex-row xl:flex-row flex-col gap-15 px-4 md:px-[clamp(28px,6.53vw,188px)] py-8 md:py-[clamp(28px,4.86vw,70px)] mt-10 md:mt-25 ">
        ...
        <div className="flex flex-col md:gap-5 w-full">
          ...
          <div className="flex lg:flex-row flex-col md:gap-[clamp(20px,9.73vw,280px)] md:px-10 pt-4 md:pt-0">
            ...
            <motion.div
              ...
              <p
                className="font-montserrat font-medium text-[#575757] text-[clamp(14px,3.88vw,16px)] md:text-[#000000] md:text-[clamp(16px,1.52vw,44px)] leading-[clamp(24px,3vw,40px)] md:leading-[clamp(24px,2.5vw,72px)]">
        ...
        <div className="flex sm:flex-row flex-col sm:justify-between items-center gap-20">
          ...
          <motion.div
            ...
            <img
              src={image87}
              alt="clock"
              className="flex-shrink-0 w-[clamp(60px,16.50vw,67px)] md:w-[clamp(60px,5.902vw,170px)] h-[clamp(60px,16.50vw,67px)] md:h-[clamp(60px,5.902vw,170px)] object-contain aspect-[67.09/67.091]"
            />
        ...
        <div className="flex lg:flex-row flex-col gap-10 bg-[rgba(55,55,55,0.10)] md:p-9.5 px-4 py-6 m:py-0">
          <div className="flex flex-col flex-1 items-center sm:items-start gap-[clamp(24px,2.055vw,470px)]">
            ...
            <p className="font-montserrat font-medium text-[#575757] text-[clamp(12px,3.88vw,16px)] md:text-[clamp(16px,1.319vw,38px)] leading-[clamp(23px,6.56vw,27px)] md:leading-[clamp(23px,1.875vw,54px)]">
              ...
              want to break into the world of software development.
              <br />
              You’ll learn how to become a Full Stack Developer — someone
              skilled in both front-end and back-end technologies, capable of
      ...
      <footer className="flex justify-center bg-[rgb(47,54,69)] px-4 py-10 md:pt-[clamp(10px,3.125vw,45px)] md:pr-[clamp(94px,3.40vw,49px)] pb-20 md:pl-[clamp(94px,8.19vw,236px)]">
        <div className="flex md:flex-row flex-col justify-between w-full">
          ...
          {/* Contact Info  */}
          <div className="  mt-6 md:mt-0 flex flex-col items-center md:items-start space-y-4 text-center md:text-center ">
