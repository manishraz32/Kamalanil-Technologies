          ...
          <div className="relative h-[180px]">
            ...
            <div className="top-[35%] z-30 absolute flex flex-col items-center pl-3 sm:pl-4 md:pl-5 lg:pl-22 2xl:pl-30 3xl:pl-35 4xl:pl-40 xl:pl-30 text-white">
              <div className="flex items-center gap-2 mb-2 font-medium text-[14px]">
                <span className="md:text-[clamp(18px,1.38vw,20px)] leading-5 md:leading-[clamp(20px, 1.45vw, 63px)]">Submitted successfully</span>
                <img
                  src={CheckIcon}
                  alt="Check"
              ...
              <p className="text-[13px] md:text-[clamp(13px,1.11vw,48px)] md:leading-[clamp(20px, 1.45vw, 63px)]">Our team will call you shortly.</p>

              <button
                onClick={onClose}
                className="bg-[#21B495] hover:bg-[#21B495] shadow-md mt-4 md:mt-2 mb-5 px-25 py-2 rounded-full font-medium text-[16px] text-white leading-[clamp(20px,1.45vw,63px)] transition"
              >
                OK
              </button>
            </div>
